...
var ASM_CONSTS = {
  4467888: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4467943: function($0) {performance.now = function() { return $0; };},  
 4467991: function($0) {performance.now = function() { return $0; };},  
 4468039: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4468094: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4468155: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4468219: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _NEXPLAYERUnity_AsyncCmdResult() {
      return getEventAsyncCMDResult();
    }

  function _NEXPLAYERUnity_AsyncCmdType() {
      return getEventAsyncCMDType();
    }

  function _NEXPLAYERUnity_AsyncCmdValue() {
      return getEventAsyncCMDValue();
    }

  function _NEXPLAYERUnity_Close() {
      closePlayer();
    }

  function _NEXPLAYERUnity_GetContentInfoInt(info_index) {
      return getContentInfo(info_index);
    }

  function _NEXPLAYERUnity_GetPlayerStatus() {
      return getPlayerStatus();
    }

  function _NEXPLAYERUnity_Init(url, serverKey) {
      setUpContext(GL);
    }

  function _NEXPLAYERUnity_IsFirefox() {
      return navigator.userAgent.search("Firefox") > -1;
    }

  function _NEXPLAYERUnity_NativeGetVersionMajor(){
     return NativeGetVersionMajor();
    }

  function _NEXPLAYERUnity_NativeGetVersionMinor(){
     return NativeGetVersionMinor();
    }

  function _NEXPLAYERUnity_NativeGetVersionPatch(){
     return NativeGetVersionPatch();
    }

  function _NEXPLAYERUnity_Open(url) {
      setUpNexPlayer(UTF8ToString(url));
    }

  function _NEXPLAYERUnity_Pause() {
      pause();
    }

  function _NEXPLAYERUnity_QueueIsEmpty() {
      return isEventQueueEmpty();
    }

  function _NEXPLAYERUnity_Resume() {
      resume();
    }

  function _NEXPLAYERUnity_Seek(milliseconds) {
      seek(milliseconds);
    }

  function _NEXPLAYERUnity_SetAudioStream(id) {
  
    }

  function _NEXPLAYERUnity_SetCaptionStream(id) {
  
    }

  function _NEXPLAYERUnity_SetTrack(trackID) {
      setCurrentTrack(trackID);
    }

  function _NEXPLAYERUnity_SetWebGLKey(nexPlayerKey) {
      setWebGLKey(UTF8ToString(nexPlayerKey));
    }

  function _NEXPLAYERUnity_Start(milliseconds) {
      start(milliseconds);
    }

  function _NEXPLAYERUnity_Stop() {
      stopPlayer();
    }

  function _NexPlayerUnity_ReleasePlayer() {
      releasePlayer(GL.textures);
    }

  function _NexPlayerUnity_SetAutoPlayback(autoPlayback) {
      setAutoPlayback(autoPlayback);
    }

  function _NexPlayerUnity_SetVolume(value) {
      setVolume(value);
    }

  function _UpdateTextureFromUnity(textureId, textureWidth, textureHeight) {
...
var asmLibraryArg = {
  ...
  "NEXPLAYERUnity_AsyncCmdResult": _NEXPLAYERUnity_AsyncCmdResult,
  "NEXPLAYERUnity_AsyncCmdType": _NEXPLAYERUnity_AsyncCmdType,
  "NEXPLAYERUnity_AsyncCmdValue": _NEXPLAYERUnity_AsyncCmdValue,
  "NEXPLAYERUnity_Close": _NEXPLAYERUnity_Close,
  "NEXPLAYERUnity_GetContentInfoInt": _NEXPLAYERUnity_GetContentInfoInt,
  "NEXPLAYERUnity_GetPlayerStatus": _NEXPLAYERUnity_GetPlayerStatus,
  "NEXPLAYERUnity_Init": _NEXPLAYERUnity_Init,
  "NEXPLAYERUnity_IsFirefox": _NEXPLAYERUnity_IsFirefox,
  "NEXPLAYERUnity_NativeGetVersionMajor": _NEXPLAYERUnity_NativeGetVersionMajor,
  "NEXPLAYERUnity_NativeGetVersionMinor": _NEXPLAYERUnity_NativeGetVersionMinor,
  "NEXPLAYERUnity_NativeGetVersionPatch": _NEXPLAYERUnity_NativeGetVersionPatch,
  "NEXPLAYERUnity_Open": _NEXPLAYERUnity_Open,
  "NEXPLAYERUnity_Pause": _NEXPLAYERUnity_Pause,
  "NEXPLAYERUnity_QueueIsEmpty": _NEXPLAYERUnity_QueueIsEmpty,
  "NEXPLAYERUnity_Resume": _NEXPLAYERUnity_Resume,
  "NEXPLAYERUnity_Seek": _NEXPLAYERUnity_Seek,
  "NEXPLAYERUnity_SetAudioStream": _NEXPLAYERUnity_SetAudioStream,
  "NEXPLAYERUnity_SetCaptionStream": _NEXPLAYERUnity_SetCaptionStream,
  "NEXPLAYERUnity_SetTrack": _NEXPLAYERUnity_SetTrack,
  "NEXPLAYERUnity_SetWebGLKey": _NEXPLAYERUnity_SetWebGLKey,
  "NEXPLAYERUnity_Start": _NEXPLAYERUnity_Start,
  "NEXPLAYERUnity_Stop": _NEXPLAYERUnity_Stop,
  "NexPlayerUnity_ReleasePlayer": _NexPlayerUnity_ReleasePlayer,
  "NexPlayerUnity_SetAutoPlayback": _NexPlayerUnity_SetAutoPlayback,
  "NexPlayerUnity_SetVolume": _NexPlayerUnity_SetVolume,
  "UpdateTextureFromUnity": _UpdateTextureFromUnity,
